...
export class Migration20250930015614 extends Migration {

  override async up(): Promise<void> {
    this.addSql(`alter table if exists "mega_menu_config" drop constraint if exists "mega_menu_config_category_id_unique";`);
