...
module.exports = {
    ...
    extend: {
      ...
      colors: {
        ...
        secondary: {
          ...
          hover: withOpacityValue("--secondary-hover"),
        },
        destructive: {
        ...
        surface: {
          ...
          hover: withOpacityValue("--surface-hover"),
        },
        text: {
          DEFAULT: withOpacityValue("--text-primary"),
        ...
        tooltip: {
          DEFAULT: withOpacityValue("--tooltip"),
          foreground: withOpacityValue("--tooltip-foreground"),
        },
        background: {
          DEFAULT: withOpacityValue("--background"),
        },
      },
      borderRadius: {
        lg: "var(--radius)",
  ...
  plugins: [require("tailwindcss-radix")(), require("tailwindcss-animate"), require("tailwindcss-bg-patterns")],
};
