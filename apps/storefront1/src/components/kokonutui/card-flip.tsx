    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    <div className="relative h-full overflow-hidden bg-gradient-to-b from-zinc-100 to-white dark:from-zinc-900 dark:to-black flex flex-col">
                        {/* Main image area - full coverage */}
                        ...
                        <div className="absolute top-0 left-0 right-0 p-4">
                            <div className="flex items-center justify-center">
                                <h3 className="text-lg font-semibold text-gray-800 leading-snug tracking-tighter transition-all duration-500 ease-out-expo group-hover:translate-y-[-4px] line-clamp-1 text-center">
                                    {title}
                                </h3>
                            </div>
                        </div>
                ...
                >
                    <div className="relative h-full flex flex-col p-0">
                        ...
                        <div className="absolute bottom-2 left-0 right-0 px-4 pb-2">
                            <p className="text-sm text-gray-600 tracking-tight transition-all duration-500 ease-out-expo group-hover:translate-y-[-2px] line-clamp-1 leading-tight">
                                {description}
                            </p>
                        </div>
                    </div>
